...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './like.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIKE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIKE actions', async () => {
      const expectedActions = [
        {
