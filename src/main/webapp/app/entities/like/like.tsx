  ...
  return (
    <div>
      <h2 id="like-heading" data-cy="LikeHeading">
        <Translate contentKey="songSocietyApp.like.home.title">Likes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="songSocietyApp.like.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/like/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="songSocietyApp.like.home.createLabel">Create new Like</Translate>
          </Link>
        </div>
      </h2>
          ...
          {likeList && likeList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="songSocietyApp.like.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('date')}>
                    <Translate contentKey="songSocietyApp.like.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="songSocietyApp.like.user">User</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="songSocietyApp.like.post">Post</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {likeList.map((like, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{like.date ? <TextFormat type="date" value={like.date} format={APP_DATE_FORMAT} /> : null}</td>
                    <td>{like.user ? like.user.login : ''}</td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="songSocietyApp.like.home.notFound">No Likes found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
