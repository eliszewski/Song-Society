...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './music.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MUSIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_MUSIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MUSIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MUSIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MUSIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MUSIC actions', async () => {
      const expectedActions = [
        {
