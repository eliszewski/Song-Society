...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reply.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPLY_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPLY actions', async () => {
      const expectedActions = [
        {
