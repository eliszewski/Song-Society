...
/**
 * REST controller for managing {@link com.society.domain.Follow}.
 */
@RestController
@RequestMapping("/api")
public class FollowResource {
     ...
     */
    @GetMapping("/follows")
    public List<FollowDTO> getAllFollows(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
